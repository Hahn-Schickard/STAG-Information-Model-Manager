 ...
 * The implementation of this class exists in
 * Model_Factory::DeviceElementGroupImpl
 * @attention This class should be instantiated by Model_Factory::DeviceBuilder
 * only!
